...
public class CmsPatternPanelMonthly extends Composite implements HasValueChangeHandlers<String> {
    ...
    public CmsPatternPanelMonthly(JSONObject labels) {
        ...
        m_labelDays.setInnerText(m_labels.get("GUI_SERIALDATE_MONTHLY_MONTHDAY_DAY_EVERY_0").isString().stringValue());
        m_everyMonth.setText("1");
        m_labelMonths.setInnerText(m_labels.get("GUI_SERIALDATE_MONTHLY_MONTH_0").isString().stringValue());

        m_labelEvery.setInnerText(m_labels.get("GUI_SERIALDATE_MONTHLY_WEEKDAY_EVERY_0").isString().stringValue());
        m_labelMonth.setInnerText(m_labels.get("GUI_SERIALDATE_MONTHLY_MONTH_0").isString().stringValue());
        m_atMonth.setText("1");
        initSelectBoxes();
    }
    ...
    private void initSelectBoxes() {
        ...
        m_atWeek.addOption("1", m_labels.get("GUI_SERIALDATE_WEEKDAYNUMBER_1_0").isString().stringValue());
        m_atWeek.addOption("2", m_labels.get("GUI_SERIALDATE_WEEKDAYNUMBER_2_0").isString().stringValue());
        m_atWeek.addOption("3", m_labels.get("GUI_SERIALDATE_WEEKDAYNUMBER_3_0").isString().stringValue());
        m_atWeek.addOption("4", m_labels.get("GUI_SERIALDATE_WEEKDAYNUMBER_4_0").isString().stringValue());
        m_atWeek.addOption("5", m_labels.get("GUI_SERIALDATE_WEEKDAYNUMBER_5_0").isString().stringValue());
