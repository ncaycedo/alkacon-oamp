...
public class CmsSerialDate extends Composite implements I_CmsFormWidget, I_CmsHasInit, HasValueChangeHandlers<String> {
    ...
    public CmsSerialDate(JSONObject labels) {
        ...
        m_yearlyRadioButton = new CmsRadioButton(
            KEY_YEARLY,
        ...
        // init labels
        m_startTimeLabel.setInnerText(m_labels.get("GUI_SERIALDATE_TIME_STARTTIME_0").isString().stringValue());
        m_endTimeLabel.setInnerText(m_labels.get("GUI_SERIALDATE_TIME_ENDTIME_0").isString().stringValue());
        //     m_durationLabel.setInnerText();
        m_startDateLabel.setInnerText(m_labels.get("GUI_SERIALDATE_TIME_STARTDATE_0").isString().stringValue());
