/*
 * File   : $Source: /alkacon/cvs/alkacon/com.alkacon.opencms.v8.calendar/src/com/alkacon/opencms/v8/calendar/CmsSerialDateXmlContentHandler.java,v $
                                ...
                                if (content.hasValue(xPath + "Time", locale)) {
                                    try {
                                        ...
                                        String dateStr = CmsSerialDateWidget.getCalendarLocalizedTime(
                                            ...
                                            true,
                                            false);
                                        time = CmsCalendarWidget.getCalendarDate(
                                            messages,
                                            dateStr + " " + content.getStringValue(cms, xPath + "Time", locale),
                                            true);
                                    } catch (Exception e) {
