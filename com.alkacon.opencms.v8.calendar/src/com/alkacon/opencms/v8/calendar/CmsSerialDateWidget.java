...
public class CmsSerialDateWidget extends CmsCalendarWidget {
    ...
    /** The request parameter name for the occurrences parameter. */
    ...
    public void setEditorValue(
        ...
        if ((values != null) && (values.length > 0)) {
            ...
            if (String.valueOf(I_CmsCalendarSerialDateOptions.END_TYPE_TIMES).equals(endType)) {
                params.put(I_CmsCalendarSerialDateOptions.CONFIG_OCCURRENCES, getParameterValue(
                    PARAM_OCCURRENCES,
                    formParameters));
            }
    ...
    protected CmsMacroResolver getMacroResolverForForm(
        ...
        resolver.addMacro(MACRO_PREFIX_PARAMVALUE + PARAM_OCCURRENCES, String.valueOf(occurrences));
